...
axHandle = theSIM.m_hGUI.handles.ViewAxes;
set(axHandle,'ActivePositionProperty','position');
set(axHandle,'Position',[0.05 0.05 0.9 0.9]);
% axHandle = gca;
...
%     h = image(lonVect,latVect,uniImag);  
    h = surface(uniLonMesh,uniLatMesh,zeros(size(uniLonMesh)),uniImag,...
